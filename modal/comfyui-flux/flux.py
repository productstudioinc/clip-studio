...
# ## Quickstart
#
# This example runs `workflow_api.json` in this directory, which is an adapation of [this simple FLUX.1-dev workflow](https://openart.ai/workflows/reverentelusarca/flux-simple-workflow-schnell/40OkdaB23J2TMTXHmxxu) with an Image Resize custom node added at the end.
#
...
image = (
    ...
    .apt_install(["ffmpeg"])
    .pip_install(["opencv-python", "opencv-python-headless", "imageio-ffmpeg"])
)
...
def download_models():
    models_to_download = [
        ...
        # Install PixArt XL 2 encoders
        ("PixArt-alpha/PixArt-XL-2-1024-MS", "text_encoder/model-00001-of-00002.safetensors", "clip"),
        ("PixArt-alpha/PixArt-XL-2-1024-MS", "text_encoder/model-00002-of-00002.safetensors", "clip"),
        ("PixArt-alpha/PixArt-XL-2-1024-MS", "text_encoder/model.safetensors.index.json", "clip"),
    ]
