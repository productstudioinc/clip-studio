		...
		qa: [
			{
				...
				answer: <span>Clip Studio is a tool to create AI generated videos.</span>
			},
			{
				question: 'How does Clip Studio work?',
				answer: <span>Simply enter your prompt and the video will be generated in minutes.</span>
			}
		]
	},
	{
			...
			<div className="container mx-auto my-12 max-w-[600px] space-y-12">
				{faqs.map((faq, idx) => (
					<section key={idx} id={'faq-' + faq.section}>
						...
						>
							{faq.qa.map((faq, idx) => (
								<AccordionItem key={idx} value={faq.question} className="w-full max-w-[600px]">
