...
type ScriptGenStepProps = {
  form: UseFormReturn<VideoProps>
}

export function ScriptGenStep({ form }: ScriptGenStepProps) {
  ...
  const simulateProgress = React.useCallback((duration: number) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Script & Voiceover</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold mb-4">Write Script</h3>
          ...
          <div>
            ...
            <Button
              ...
              disabled={!form.getValues('voiceId')}
            ...
            >
              ...
              <span className="text-muted-foreground ml-1">
                ~ {Math.ceil(
                  videoStructure?.reduce((acc, curr) => acc + (curr.text?.length || 0), 0) /
