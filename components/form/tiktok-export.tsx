    ...
    if (selectedAccount && state?.status === 'done') {
      try {
        await toast.promise(
          ...
          {
            loading:
              'Uploading video to TikTok, please keep this window open...',
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="w-full h-14 space-x-4 text-md" disabled={disabled}>
          <TikTokIcon className="mr-2 h-8 w-8 invert dark:invert-0" />
          Export to TikTok
        </Button>
      </DialogTrigger>
          ...
          <AccordionItem value="additional-settings">
            ...
            <AccordionContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <Label htmlFor="disclose-video-content">
                ...
                {discloseVideoContent && (
                  <div className="space-y-4">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        setVideoContentType(
                          value as 'yourBrand' | 'brandedContent'
                        )
                      }
                      className="space-y-2"
                    >
                      <TooltipProvider>
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>
                                ...
                                This video will be classified as Business
                                Organic.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>
                                You are promoting another brand or a third
                                party. This video will be classified as Branded
                                Content.
                              </p>
                            </TooltipContent>
                          </Tooltip>
