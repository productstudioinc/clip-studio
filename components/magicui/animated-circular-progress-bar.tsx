...
export default function AnimatedCircularProgressBar({
	...
	const currentPercent = state.status === 'rendering' ? state.progress * 100 : 0;
	...
	return (
		...
		>
					...
					style={
						{
							...
							transition: 'stroke-dashoffset var(--transition-length) ease var(--delay)',
			...
			<div className="absolute inset-0 m-auto flex items-center justify-center">{children}</div>
		</div>
	);
}
