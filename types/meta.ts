export namespace Facebook {
  ...
  export namespace Event {
    ...
    /**
     * Represents the manual advanced matching data.
     * https://developers.facebook.com/docs/meta-pixel/advanced/advanced-matching
     */
    export interface ManualAdvancedMatching {
      /**
       * Lowercase letters or hashed SHA-256
       */
      em?: string
      ...
      /**
       * Single lowercase letter, f or m or unknown
       */
      ge?: string

      /**
       * Digits only YYYYMMDD format, year must be 1900 or later
       */
      db?: string
